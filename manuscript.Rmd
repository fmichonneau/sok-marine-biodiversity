...
To assess the status of taxonomic expertise in the US, we calculated the proportion of specimens identified at the species level through time. For all taxa, excepts for molluscs, there is a consistent decline, indicating that specimens remain for the most part unidentified in collections (Fig.  \@ref(fig:identification-through-time)). For diverse groups such as annelids or arthropods, the proportion of specimens identified at the species-level is now below 30%. The number of scientists describing new species might be increasing globally [@Costello2013], but local experts are needed to keep identifying the species that get collected.

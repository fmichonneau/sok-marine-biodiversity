...
```{r proportion-barcoded, fig.cap='Proportion of species known to occur in the US EEZ based on iDigBio records, in the Gulf of Mexico [@Tunnell2009], in the Pacific Northwest[@Kozloff1987], that have publicly available DNA barcodes.'}

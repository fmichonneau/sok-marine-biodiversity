...
This study highlights that we have too little data about too few species of marine invertebrates, we recommend that additional coordinated field expeditions are organized to sample more thoroughly the marine environment. Data from museum collections make clear that any additional samples will contain new species and new records. Samples collected during these expeditions need to be photographed to document live appearance that would otherwise be lost during preservation. We also need to capture metadata associated with the specimens to be able to understand better the physical characteristics of the habitats for these species. Specimens need to be sub-sampled and have tissues suitable for genomic analysis preserved for their DNA barcode, or any other genomic resources. Some of these parts of data and specimen collection can be automated and captured digitally directly in the field speeding up data collection.
...
<!-- Beyond their utility in documenting diversity, metabarcoding is also promising for understanding the functioning of ecosystems. -->

...
```{r proportion-barcoded, fig.cap='Proportion of species with publicly available DNA barcodes  known to occurin the US EEZ (iDigBio and OBIS records), in the Gulf of Mexico (iDigBio, OBIS, and checklist[@Tunnell2009]), and in the Pacific Northwest (iDigBio, OBIS, and checklist[@Kozloff1996]). Numbers next to the bars indicate the number of species for which DNA barcodes are available. (\\#fig:proportion-barcoded)'}
